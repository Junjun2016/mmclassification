...
MASTER_PORT=1521 GPUS=4 GPUS_PER_NODE=4 CPUS_PER_TASK=5 tools/slurm_train.sh openmmlab swin_3 configs/swin_transformer/swin_tiny_overlap_224_b16x64_300e_imagenet.py --seed=0 &
